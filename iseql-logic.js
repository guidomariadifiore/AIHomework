document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateDropdowns() {
        ...
        const selectors = [document.getElementById('op1-predicate'), document.getElementById('op2-predicate')];
        ...
        if (select) {
            select.addEventListener('change', function() {
                ...
                if (this.value === 'EXISTING') {
                    ...
                    if (selectedOption.dataset.realName) nameInput.value = selectedOption.dataset.realName;
                } else {
    ...
    if (addConstraintBtn) {
        addConstraintBtn.addEventListener('click', () => {
            ...
            const variableOptions = `
                <option value="M1.arg1">M1.arg1 (Person A)</option>
                <option value="M1.arg2">M1.arg2 (Item A)</option>
                <option value="M1.sf">M1.sf (Start Frame)</option>
                <option value="M1.ef">M1.ef (End Frame)</option>
                <option value="M2.arg1">M2.arg1 (Person B)</option>
                <option value="M2.arg2">M2.arg2 (Item B)</option>
                <option value="M2.sf">M2.sf (Start Frame)</option>
